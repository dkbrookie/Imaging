...
powershell.exe -ExecutionPolicy Bypass -Command "& {`$locationID = 401; (new-object Net.WebClient).DownloadString('https://raw.githubusercontent.com/dkbrookie/Imaging/master/Basic_App_Deploy/Powershell/Automate_Agent.ps1') | iex;}"
